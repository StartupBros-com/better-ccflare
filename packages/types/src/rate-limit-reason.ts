 ...
 *   breaker.
 * - `upstream_402_payment_required` — account-wide payment-required
 *   cooldown. Counts as a circuit failure.
 * - `model_scoped_429` — generic Anthropic 429 proven (by fresh usage) to
