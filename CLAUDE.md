...
This project is indexed by GitNexus as **better-ccflare** (6801 symbols, 15481 relationships, 238 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
