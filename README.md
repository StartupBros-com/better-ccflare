...
- **🤖 Multi-Provider Support** - Claude OAuth, Claude API console, Vertex AI, AWS Bedrock, NanoGPT, z.ai, Minimax, OpenRouter, Kilo, Codex (OpenAI OAuth), xAI/Grok, Meta Model API (Muse Spark), Anthropic-compatible, and OpenAI-compatible providers
...
- **Extended Provider Support** - AWS Bedrock, NanoGPT (with dynamic pricing), Minimax, OpenRouter, Kilo, Codex (OpenAI OAuth), xAI/Grok, Meta Model API (Muse Spark), Anthropic-compatible, and OpenAI-compatible providers
...
- **Meta Model API (Muse Spark)** - Meta's Muse Spark models (1M-token context) over the Anthropic Messages API at `https://api.meta.ai`, with bearer-token auth, automatic model mapping to `muse-spark-1.2`, and request normalization for Meta's strict field validation
